...
set id 1
set name mmult_fpga_fadd_32ns_32ns_32_8_full_dsp_1
...
set id 33
set name mmult_fpga_fmul_32ns_32ns_32_4_max_dsp_1
...
set ID 67
set hasByteEnable 0
set MemName mmult_fpga_A_tmp_0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 68 \
			corename mmult_fpga_control_axilite \
			name mmult_fpga_control_s_axi \
			ports {$port_control} \
			op interface \
			is_flushable 0 \ 
			is_datawidth64 0 \ 
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler mmult_fpga_control_s_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler mmult_fpga_gmem_m_axi
}
