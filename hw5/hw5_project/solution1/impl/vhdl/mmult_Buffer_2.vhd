...
architecture rtl of mmult_Buffer_2_ram is 
...
architecture arch of mmult_Buffer_2 is
    component mmult_Buffer_2_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    mmult_Buffer_2_ram_U :  component mmult_Buffer_2_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
