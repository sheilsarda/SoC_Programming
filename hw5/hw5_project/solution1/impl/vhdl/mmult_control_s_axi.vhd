...
architecture behave of mmult_control_s_axi is
    ...
    constant ADDR_INPUT_1_DATA_0  : INTEGER := 16#10#;
    constant ADDR_INPUT_1_DATA_1  : INTEGER := 16#14#;
    constant ADDR_INPUT_1_CTRL    : INTEGER := 16#18#;
    constant ADDR_INPUT_2_DATA_0  : INTEGER := 16#1c#;
    constant ADDR_INPUT_2_DATA_1  : INTEGER := 16#20#;
