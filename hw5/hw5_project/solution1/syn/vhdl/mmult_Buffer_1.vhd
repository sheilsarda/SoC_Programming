...
architecture rtl of mmult_Buffer_1_ram is 
...
architecture arch of mmult_Buffer_1 is
    component mmult_Buffer_1_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    mmult_Buffer_1_ram_U :  component mmult_Buffer_1_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
